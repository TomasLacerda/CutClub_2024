                                    ...
                                    <?php
                                        while($dados = mysqli_fetch_assoc($resultado))
                                        {
                                            ...
                                            echo "<tr class='more-info' id='info_".$dados['id']."' style='background-color: rgba(192,192,192,0.3);'>
                                                <td colspan='5'>Data início horário: ".$dados['data_inicio']."<br>Data fim horário: ".$dados['data_fim_regra']."<br>Início intervalo: ".$dados['hora_inicio_intervalo']."<br>Fim intervalo: ".$dados['hora_fim_intervalo']."<br>Folga: ".$dados['dias_semana']."<br>descricao: ".$dados['descricao'].
                                                "<br><div class='d-flex'>
