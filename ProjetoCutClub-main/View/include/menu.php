...
<script>
    // Evento de rolagem ÃÂÃÂ  pÃÂÃÂ¡gina
    window.addEventListener('scroll', function() {
        // PosiÃÂÃÂ§ÃÂÃÂ£o atual da janela de visualizaÃÂÃÂ§ÃÂÃÂ£o
        var scrollPosition = window.pageYOffset || document.documentElement.scrollTop;

        // Se a posiÃÂÃÂ§ÃÂÃÂ£o de rolagem for maior que 100 pixels, adicione a classe 'hidden' ÃÂÃÂ  navbar
        // Caso contrÃÂÃÂ¡rio, remova a classe 'hidden'
    ...
    function confirmarExclusao(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Se o usuÃÂÃÂ¡rio confirmar, redirecione para a pÃÂÃÂ¡gina de exclusÃÂÃÂ£o
